  ...
  <div class="about-wrapper">
    ...
    <div class="w3-container w3-theme-d3 w3-mobile project-section">
      <div class="w3-container w3-half w3-mobile about-main">
        <h2>PROJECTS</h2>
        <p>
          These are some of my best projects. My favorite things to do is
          styling components. There's this <b>unique</b> that comes out of it
          that just keeps me working harder. <br /><br />All languages are Java,
          Python, R, and JavaScript
        </p>
      </div>

      <div class="projects_items w3-half ">
        <div class="w3-container projects_item_scrollable">
          <div class="projects_item_self">
            <div class="project_box">
              <h2 class="w3-round" id="proj_box_title">
                Austin Thomas's Fitness App
              </h2>
              <img
              ...
              <div class="w3-container hoverbox-section">
                <div class="hover_box w3-white w3-round-xlarge w3-hover-theme2">
                  <a
